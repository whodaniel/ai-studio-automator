...
5. Click "Sign Out"
6. Check console - should see "✅ Signed out from YouTube - all auth data cleared"
...
**Expected Result:** ✅ Extension correctly switches to new account and shows Account B's playlists
...
**Expected Result:** ✅ Extension detects expired token and requires fresh authentication
...
**Expected Result:** ✅ Each sign-in correctly authenticates with the chosen account without errors
